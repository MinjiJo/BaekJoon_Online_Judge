...
@WebServlet("/Example03_1108/login_ok2")
public class login_ok2 extends HttpServlet {
 ...
 public login_ok2() {
  super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     out.write("<script>alert('"+id+"님, 로그인에 성공하셨습니다.');");
     out.write("location.href='loginSuccess.jsp'");
     out.write("</script>");
     }
     out.close();
